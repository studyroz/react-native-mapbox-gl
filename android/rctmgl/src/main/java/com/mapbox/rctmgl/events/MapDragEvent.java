...
public class MapDragEvent extends AbstractEvent {
    private LatLng newLatLng;
    private String id;
    public MapDragEvent(View view, String id, LatLng latLng) {
        super(view, EventTypes.MAP_DRAG);
        this.id = id;
